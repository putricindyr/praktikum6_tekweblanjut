      ...
      <div class="container mt-5">
        <div class="row">
          <div class="col-12 col-sm-8 offset-sm-2 col-md-6 offset-md-3 col-lg-6 offset-lg-3 col-xl-4 offset-xl-4">
            ...
            <img src="<?= base_url('template') ?>/assets/img/pink.png" alt="logo" width="100" class="shadow-light rounded-circle">
            </div>
        ...
        You Have Been <strong><?= session()->getFlashdata('message'); ?></strong>
        </div>
                ...
                <?php 
					if (isset($_POST['login'])){
						...
						if ( $row === 1 ) {
							...
							echo"<script> alert('Wrong Email or Unregistered Email')</script>";
						}
					}
					?>
              </div>
